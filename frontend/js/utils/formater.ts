export class Formatter {
  ...
  public static parseTemplate(template: string, data: Array<any>, delimiter = '%%') {
    const regexSearch = new RegExp(delimiter + '([a-zA-z0-9.]+)' + delimiter, 'gi');
  ...
  public static evaluateJSTemplate(templateString: string, data: Record<string, any>) {
    try {
