...
class Autocomplete {
  ...
  private selectedOptions: Array<AutocompleteOption> =
        ...
        switch (mutation.attributeName) {
          ...
          case "class":
            this.autocompleteSelectElement.classList.remove(
              ...Array.from(this.autocompleteSelectElement.classList).filter(
                (c) => c !== "autocomplete__select"
              )
            );
            this.autocompleteSelectElement.classList.add(
              ...Array.from(this.selectElement.classList).filter(
                (c) => c !== "hidden"
              )
            );
            break;
        ...
        if (this.autocompleteListElement.classList.contains("hidden")) {
          ...
          if (this.hoverOption) {
            ...
            if (this.hoverOption && previousSib) {
              if (
                previousSib.classList.contains("currently-selected-divider")
              ) {
                previousSib =
